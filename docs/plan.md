...
#### Day 11-12: DNG to JPG 변환 엔진- [ ] Git 저장소 초기화
...
### Week 2: 핵심 기능 구현 (11/15 ~ 11/21)- [ ] Git 저장소 초기화- **최소 지원 버전**: Android 8.0 (API 26), iOS 12.0
...
| 대용량 DNG 처리 시 메모리 부족 | 중간 | 스트리밍 변환 및 다운샘플 전략 검토 | 준비 예정 |  - Camera2 DngCreator API 연구- [x] l10n.yaml 설정- [ ] Git 저장소 초기화
